...
(A) .Rmd Line numbers where at least two different data sources are imported: 35 and 41 


(B) .Rmd Line numbers for inspecting data intake: 36, 37, 42, 43
...
(A) .Rmd Line number(s) for general data wrangling: 50-55, 60-66, 100-107, 92-95, 81-83, 187-204, 170-174, 
152-159, 129-140, 102-107, 90-95, 78-83.


(B) .Rmd Line number(s) for a join operation: 90-95


(C) .Rmd Line number(s) for a spread or gather operation (or equivalent):


(D) .Rmd Line number(s) for use of regular expressions: 71-73, 80


(E) .Rmd Line number(s) for use of reduction and/or transformation functions: 60-66, 52 
...
(A) .Rmd Line number(s) for use of mulitple different geoms: 123, 147, 165, 181, 206 

(B) .Rmd Line number(s) for use of multiple aesthetics: 121-122, 142-147, 163, 177, 206 

(C) .Rmd Line number(s) for use of layered graphics: 122, 123, 164, 178-180 
